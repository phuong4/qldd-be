...
public class BienDongThangUpdateRequest {
	...
	private String note;
	private BigDecimal hsKG;
	private BigDecimal hsKN;
	...
	public BigDecimal getHsKG() {
		return hsKG;
	}

	public void setHsKG(BigDecimal hsKG) {
		this.hsKG = hsKG;
	}

	public BigDecimal getHsKN() {
		return hsKN;
	}

	public void setHsKN(BigDecimal hsKN) {
		this.hsKN = hsKN;
	}
}
